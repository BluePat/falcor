...
module.exports = function getCachePosition(model, path) {
    ...
    while (++depth < maxDepth &&
        ...
        var key = path[depth];
        // Prevent prototype pollution by blocking access to prototype chain properties
        if (key === "__proto__" || key === "constructor" || key === "prototype") {
            return undefined;
        }
        
        // Only access own properties to prevent prototype chain traversal
        if (currentCachePosition !== null && 
            typeof currentCachePosition === "object" &&
            !Object.prototype.hasOwnProperty.call(currentCachePosition, key)) {
            return undefined;
        }
