...
// Helper function to check if a key is safe to use (prevents prototype pollution)
...
module.exports = function onValue(model, node, seed, depth, outerResults,
    ...
    if (isJSONG) {
        ...
        // Only set if key is safe to prevent prototype pollution
        if (isSafeKey(key)) {
