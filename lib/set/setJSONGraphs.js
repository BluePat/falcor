...
// Helper function to check if a key could cause prototype pollution
...
function setNode(
    ...
    if (key == null) {
        ...
        if (!isDangerousKey(key)) {
            ...
            // If key is dangerous, treat as if the node doesn't exist
            node = undefined;
            message = undefined;
        }
    }

    // Skip merging if key is dangerous
    if (!isDangerousKey(key)) {
