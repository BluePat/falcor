...
function serialize(cache) {
    ...
    function internalKeys(x) {
        return (x[0] !== '_' || x[1] !== '_') && x !== '__proto__' && x !== 'constructor' && x !== 'prototype';
    }
}
...
function deserialize(cache) {
    ...
    function internalKeys(x) {
        return x[0] !== '$' && (x[0] !== '_' || x[1] !== '_') && x !== '__proto__' && x !== 'constructor' && x !== 'prototype';
    }
}
    ...
    if (obj === null || typeof obj !== 'object') {
        ...
        do {
            ...
            for (keyCount = 0; keyCount < keys.length; keyCount++) {
                key = keys[keyCount];
                if ((key[0] !== '_' || key[1] !== '_') && key !== '__proto__' && key !== 'constructor' && key !== 'prototype') {
